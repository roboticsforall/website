...
export const Newsletter: React.FC = () => {
    ...
    return (
      <>
        <Header headerTextColor = {ColorThemes.mainYellow} image = {headerBlobYellow} title = {"Read more about our work!"} description = {"Read through our monthly newsletter to learn more about our work!"}/>
        <Container>
          <Row>
          ...
          <Row>
            {newsletterJSON.newsletters_list.slice(0,4).map((newsletter, i) => (
              <Col key = {i} md>
                <NewsCard title = {newsletter.date} file = {newsletter.file_path.replace("/public", "")}/>
                <br/>
              </Col>
            ))}
          </Row>
          ...
          <LongButton title = {"Read Previous Newsletters"} location = "/about/pastnewsletter"/>
          <br></br>
          <br></br>
          <Row>
          ...
          <Row>
            ...
            <br></br>
              ...
              <SubmitButton className = "clear button" type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe"/>
          </div>
