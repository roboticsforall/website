        ...
        <div>
            ...
            <Container fluid>
                ...
                <Container>
                    ...
                    <p className = "text-center" style={description}>Robotics for All aims to inspire the next generation of students and volunteers to achieve their full potential, regardless of their background.</p>
                </Container>
                <br/> 
            </Container>
            <Container fluid style={{ backgroundColor: "#B7EDC9"}}>
                ...
                <Container>
                    ...
                    <p className = "text-center" style={description}>A world where all students are able to access equitable educational opportunities to create their futures.</p>
                </Container>
                <br/>
            </Container>
            <Container fluid>
