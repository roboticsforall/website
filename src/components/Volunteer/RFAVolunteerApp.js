        ...
        <Container>
          <Tab.Container activeKey = {key} onSelect = {key => setKey(key)}>
              <Nav justify fill variant = "tabs">
                <Nav.Item>
                  <Nav.Link eventKey = "one" style = {key === "one" ? ActiveStyle : ActiveStyle}>Teacher Application</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey = "two" style = {key === "two" ? ActiveStyle2 : ActiveStyle2}>Publicity Application</Nav.Link>
                </Nav.Item>
              </Nav>
              <Tab.Content>
