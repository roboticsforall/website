...
export const RFAPastNewsletter: React.FC = (props) => {
    ...
    return (
      <>
        <RFAHeader headerTextColor = {"#ffcc00"} image = {headerBlobYellow} title = {"Read through our past monthly newsletters to learn more about our work!"} description = {"Read through our past monthly newsletters to learn more about our work!"}/>
        <Container>
