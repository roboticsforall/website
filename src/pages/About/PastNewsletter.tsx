...
export const PastNewsletter: React.FC = () => {
    ...
    return (
      <>
        <Header headerTextColor = {ColorThemes.mainYellow} image = {headerBlobYellow} title = {"Read through our past monthly newsletters to learn more about our work!"} description = {"Read through our past monthly newsletters to learn more about our work!"}/>
        <Container>
