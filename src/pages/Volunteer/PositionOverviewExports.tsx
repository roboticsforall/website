...
const options = {
    businessProps: {
        ...
        headerDescription: "General Business Interns help with a variety of tasks from recruitment to data analysis!",
    ...
    publicityProps : {
        ...
        headerDescription: "Volunteer to help with graphic design, illustrations, and much much more!",
    ...
    technicalProps : {
        ...
        headerDescription: "Technical interns use their STEM skills to create and revise curriculum and make custom software.",
    ...
    curricDevProps : {
        ...
        headerDescription: "Curriculum developers construct the diverse set of curriculum at Robotics For All",
        data: curricdevpositionsJSON,
        headerBlob: headerBlobYellow,
    }
}

export const PositionsOverview = ({path} : {path : string}) : JSX.Element => { 
    switch (path) {
