                ...
                <div class="circle1">
                  <div class="circle-text">
                    ...
                    <div class="stats_numbers">
                      <CountUp end={12} start={1} preserveValue={true}>
                        {({ countUpRef, start }) => (
                          <VisibilitySensor //starts counting up when numbers are visible
                            onChange={(isVisible) => {
                              if (!this.counted1 && isVisible) {
                                  this.counted1 = true
                                  start()
                                }
                            }}
              ...
              <Col>
                <div class="circle2">
                  <div class="circle-text">
                    ...
                    <div class="stats_numbers">
                      <CountUp end={164} start={1} preserveValue={true}>
                        {({ countUpRef, start }) => (
                          <VisibilitySensor
                            onChange={(isVisible) => {
                                if (!this.counted2 && isVisible) {
                                  this.counted2 = true
                                  start()
                                }
                            }}
              ...
              <Col>
                <div class="circle3">
                  <div class="circle-text">
                    ...
                    <div class="stats_numbers">
                      <CountUp end={1027} start={1} preserveValue={true}>
                        {({ countUpRef, start }) => (
                          <VisibilitySensor
                            onChange={(isVisible) => {
                                if (!this.counted3 && isVisible) {
                                  this.counted3 = true
                                  start()
                                }
                            }}
