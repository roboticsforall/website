...
export default function RFARegister(props){
    return (
      <>
        <RFAHeader headerTextColor = {"#3399ff"} image = {headerBlobBlue} title = {"Sign up for the next session of classes!"} description = {"Fill out the form below to sign up for our classes today!"}/>
        <br/><br/><br/><br/>
        <Container>
          <Row>
